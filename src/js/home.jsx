        ...
        <div className="homepage-top">
          <div className="row">
            <div className="homepage-box large-12 columns large-centered">
              ...
              <p>This database, which was released in June 2017, is an open-access resource for learning about transnational standard-setting MSIs. The database catalogued publicly available information about the institutional design of MSIs to provide an overview of the governance and operations of these initiatives.</p>
              ...
              <br/>
              <br/>
              <p>NOTE: In 2020, MSI Integrity released a new report on MSIs, <i><a href="https://www.msi-integrity.org/not-fit-for-purpose/">Not Fit-For-Purpose: The Grand Experiment of Multi-Stackeholder Initiatives in Corporate Accountability, Human Rights, and Global Governance,</a></i> which provides more recent data, current through June 2019, on the MSIs listed in this database. The database was not updated to reflect this new data, except that we revised the names and launch dates of the MSIs in the database, updated some mission statements, and eliminated five MSIs from the original list of 45 for consistency with our final set of research into MSIs. For more information about these revisions, see our <a href="/data/Project%20Methodology%20and%20Classification%20Guide%20-%20MSI%20Database.pdf">Project Methodology</a>.</p>
              <p>Beyond the revisions stated here, the database was not and will not be updated any further. MSI Integrity is shifting to a new and exciting research focus: looking <a href="https://www.msi-integrity.org/beyond-corporations/">beyond corporations</a> to support the promotion of business models that center workers and communities in their ownership and governance.</p>
              <p>If you wish to explore more recent data on the 40 MSIs in our database, explore our 2020 report, <a href="https://www.msi-integrity.org/not-fit-for-purpose/">Not Fit-For-Purpose</a>.</p>
            </div>
          </div>
        </div>
      </div>
