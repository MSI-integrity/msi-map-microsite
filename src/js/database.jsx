    ...
    return (
      <div key={-1} className="search-container row">
        <div className="small-12 columns explore-info">
          ...
          <p>
            If you wish to explore more recent data on the 40 MSIs now in our MSI Database, explore our 2020 report, <a href="http://www.msi-integrity.org/not-fit-for-purpose/">Not Fit-For-Purpose</a>.
          </p>
        </div>
        <div className="row">
